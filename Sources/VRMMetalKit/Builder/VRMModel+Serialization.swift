...
extension VRMModel {
    ...
    public func serialize(to url: URL) throws {
        ...
        vrmLog("[VRMModel] VRM file written successfully: \(glbData.count) bytes (\(binaryData.count) bytes binary data)")
    }
        ...
        if !expression.materialColorBinds.isEmpty {
            dict["materialColorBinds"] = expression.materialColorBinds.map { bind in
                return [
                    ...
                    "targetValue": [bind.targetValue.x, bind.targetValue.y, bind.targetValue.z, bind.targetValue.w]
                ]
            }
        }
    ...
    private func createGLB(json: [String: Any], binaryData: Data) throws -> Data {
        ...
        // Header
        glbData.append(UInt32(0x46546C67).littleEndian.data) // magic "glTF"
        ...
        glbData.append(UInt32(0x4E4F534A).littleEndian.data) // chunk type "JSON"
        ...
        if !binaryData.isEmpty {
            ...
            glbData.append(UInt32(0x004E4942).littleEndian.data) // chunk type "BIN\0"
