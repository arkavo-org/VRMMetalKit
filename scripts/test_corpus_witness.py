...
class Widths(unittest.TestCase):
    ...
    def test_the_generator_and_the_runner_derive_widths_from_one_definition(self):
        self.assertIs(W.rule_widths, R.rule_widths,
                      "the solver scores residuals on these widths and the runner scores the replayed "
                      "result on them; a second copy could diverge without either side noticing")
